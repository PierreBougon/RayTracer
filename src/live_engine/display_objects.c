/*
** display_objects.c<live_engine> for RAYTRACER in /home/samuel_r/EPITECH/GFX/gfx_raytracer2
**
** Made by romain samuel
** Login   <samuel_r@epitech.net>
**
** Started on  Mon Apr 18 19:22:58 2016 romain samuel
** Last update Mon Apr 18 20:33:06 2016 romain samuel
*/

#include "raytracer.h"

int		live_display_sphere(t_rt *s, t_object *obj)
{
  t_sphere	*shape;
...
int		live_display_cylinder(t_rt *s, t_object *obj)
{
  t_cylinder	*shape;
...
int		live_display_cone(t_rt *s, t_object *obj)
{
  t_cone	*shape;
